...
export const WEDDING = {
  ...
  location: { lat: 36.9882, lng: 127.1131, placeName: "티웨딩홀", address: "경기 평택시 평택5로34번길 6-5" },
  naviLinks: {
    tmap: "tmap://route?goalname=티웨딩홀+평택&goaly=36.9882&goalx=127.1131",
    kakaoNavi: "kakaomap://route?ep=127.1131,36.9882&ename=티웨딩홀&by=CAR",
    naverMap: "nmap://route/public/goal?dlat=36.9882&dlng=127.1131&dname=티웨딩홀+평택&appname=wedding",
    tmapWeb: "https://www.tmap.co.kr/",
    kakaoNaviWeb: "https://map.kakao.com/link/to/티웨딩홀,36.9882,127.1131",
